...
import com.dingle.tinnews.common.ViewModelAdapter;
import com.dingle.tinnews.mvp.MvpFragment;
import com.dingle.tinnews.save.detail.TitleViewModel;
...
public class TinProfileFragment extends MvpFragment<ProfileContract.Presenter> implements ProfileContract.View {
    ...
    public void setView() {
        if (viewModelAdapter.isEmpty()) {
            ...
            viewModelAdapter.addViewModel(new RowTextViewModel(getString(R.string.jp), presenter.getOnCountryChangeListener(getString(R.string.jp))));
        }
    }
